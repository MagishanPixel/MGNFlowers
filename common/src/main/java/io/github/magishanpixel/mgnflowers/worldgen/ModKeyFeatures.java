...
public class ModKeyFeatures {
    ...
    private static KeyFeature of(String name) {
        return new KeyFeature(ResourceKey.create(Registries.CONFIGURED_FEATURE, MGNConstants.newId(name)), ResourceKey.create(Registries.PLACED_FEATURE, MGNConstants.newId(name)));
    }
}
