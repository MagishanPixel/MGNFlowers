...
public record NoiseTallerFlowerConfig(int maxHeight, long seed, NormalNoise.NoiseParameters noiseParams, float scale, List<Block> flowers) implements FeatureConfiguration {
