...
public class CustomFlowerBlock extends FlowerBlock {
    ...
    public CustomFlowerBlock(MobEffect suspiciousStewEffect, int effectDuration, @Nullable MayPlace mayPlace, Properties properties) {
        this(suspiciousStewEffect, effectDuration, mayPlace, null, properties);
    }

    public CustomFlowerBlock(MobEffect suspiciousStewEffect, int effectDuration, @Nullable MayPlace mayPlace, @Nullable VoxelShape shape, Properties properties) {
