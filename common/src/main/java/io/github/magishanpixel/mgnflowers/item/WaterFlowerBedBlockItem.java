...
public class WaterFlowerBedBlockItem extends BlockItem {
    public WaterFlowerBedBlockItem(Block block, Properties prop) {
        super(block, prop);
    }
    ...
    public InteractionResult use(Level level, Player plr, InteractionHand hand) {
        ...
        return super.useOn(new UseOnContext(plr, hand, res));
    }
}
