...
public class ModBlocks {
    ...
    public static void init(BalmBlockRegistrar blocks) {
        ...
        WHITE_TWIN_POPPY = construct.registerBasic(PrefList.TWIN_POPPY.colorOf(StraddColor.white), MobEffects.NAUSEA, 6, DyeColor.WHITE);
        RED_TWIN_POPPY = construct.registerBasic(PrefList.TWIN_POPPY.colorOf(StraddColor.red), MobEffects.ABSORPTION, 2, DyeColor.RED);
        PINK_TWIN_POPPY = construct.registerBasic(PrefList.TWIN_POPPY.colorOf(StraddColor.pink), MobEffects.INSTANT_HEALTH, 2, DyeColor.PINK);
        ...
        RED_TALL_TULIP = construct.registerSameProperty(PrefList.TALL_TULIP.colorOf(StraddColor.red), a -> new TallerFlowerBlock(MobEffects.RESISTANCE, 4, a), flowerProp().dye(DyeColor.RED).notSmall().build());
        ...
        PURPLE_TALL_TULIP = construct.registerSameProperty(PrefList.TALL_TULIP.colorOf(StraddColor.purple), a -> new TallerFlowerBlock(MobEffects.MINING_FATIGUE, 4, a), flowerProp().dye(DyeColor.PURPLE).notSmall().build());
        ...
        PINK_GINGER_LILY = construct.registerSameProperty(PrefList.GINGER_LILY.colorOf(StraddColor.pink), a -> new TallerFlowerBlock(MobEffects.INSTANT_HEALTH, 2, a), flowerProp().dye(DyeColor.PINK).notSmall().build());
        ...
        BLEEDING_HEART = construct.registerBasic("bleeding_heart", MobEffects.INSTANT_HEALTH, 3, DyeColor.RED);
        ...
        BEE_BALM = construct.registerBasic("bee_balm", MobEffects.MINING_FATIGUE, 4, DyeColor.YELLOW);
        ...
        PINK_ROMENTA = construct.registerBasic(PrefList.ROMENTA.colorOf(StraddColor.pink), MobEffects.INSTANT_HEALTH, 3, DyeColor.PINK);
        BLUE_ROMENTA = construct.registerBasic(PrefList.ROMENTA.colorOf(StraddColor.blue), MobEffects.NAUSEA, 8, DyeColor.BLUE);
        ...
        PURPLE_HYACINTH = construct.registerSameProperty(PrefList.HYACINTH.colorOf(StraddColor.purple), a -> new CustomFlowerBlock(MobEffects.MINING_FATIGUE, 4, null, SHAPE_hyacinth, a), DyeColor.PURPLE);
        ...
        RED_HYACINTH = construct.registerSameProperty(PrefList.HYACINTH.colorOf(StraddColor.red), a -> new CustomFlowerBlock(MobEffects.INSTANT_HEALTH, 4, null, SHAPE_hyacinth, a), DyeColor.RED);
        ...
        YELLOW_HYACINTH = construct.registerSameProperty(PrefList.HYACINTH.colorOf(StraddColor.yellow), a -> new CustomFlowerBlock(MobEffects.NAUSEA, 4, null, SHAPE_hyacinth, a), DyeColor.YELLOW);
        ...
        PINK_CYCLAMEN = construct.registerBasic(PrefList.CYCLAMEN.colorOf(StraddColor.pink), MobEffects.MINING_FATIGUE, 4, flowerProp().disableOffset().dye(DyeColor.PINK).build());
        WHITE_CYCLAMEN = construct.registerBasic(PrefList.CYCLAMEN.colorOf(StraddColor.white), MobEffects.NAUSEA, 10, flowerProp().disableOffset().dye(DyeColor.WHITE).build());

        TRILLIUM = construct.registerBasic("trillium", MobEffects.INSTANT_HEALTH, 1, flowerProp().dye(DyeColor.WHITE).disableOffset().build());
    ...
    private static BlockBehaviour.Properties setPropFlower(BlockBehaviour.Properties prop) {
        return prop.mapColor(MapColor.PLANT).noCollision().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ).pushReaction(PushReaction.DESTROY);
    }
