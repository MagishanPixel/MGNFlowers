...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput recipeOutput) {
        if (OddLib.dataGenList != null) {
            for (Map.Entry<String, ModBlocks.FlowerProperty> entry : OddLib.dataGenList.entrySet()) {
                ...
                Item flower = BuiltInRegistries.ITEM.get(OddLib.newId(entry.getKey()));
