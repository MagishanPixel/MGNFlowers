package io.github.magishanpixel.mgnflowers.fabric.datagen.world;
...
public class ConfiguredFeatureBootstrap {
    public static void boot(BootstapContext<ConfiguredFeature<?,?>> context) {
        ...
        createBedPatch(context, ModKeyFeatures.DANDELION_BED_PATCH.config(), 96, 6, 2, ModBlocks.DANDELION_BED.get(), 4);
        createPatch(context, ModKeyFeatures.SUNFLOWER_BED_PATCH.config(), 75, 6, 2, builderBedPatch(ModBlocks.SUNFLOWER_BED.get(), 4, 2).add(Blocks.SUNFLOWER.defaultBlockState(), 1));
        ...
        createPatch(context, ModKeyFeatures.TALL_TULIP_PATCH.config(), 48, 7, 2,
                ...
                new TallerFlowerConfig(4,
                        List.of(
                                ModBlocks.PURPLE_TALL_TULIP.get(),
                                ModBlocks.TURQUOISE_TALL_TULIP.get(),
                                ModBlocks.PINK_TALL_TULIP.get(),
                                ModBlocks.RED_TALL_TULIP.get(),
                                ModBlocks.WHITE_TALL_TULIP.get(),
                                ModBlocks.ORANGE_TALL_TULIP.get()
                        ))
        );
        ...
        createPatch(context, ModKeyFeatures.TALL_ALLIUM_PATCH.config(), 56, 7, 2,
                ...
                new NoiseTallerFlowerConfig(4,
                        ...
                        1.0F,
                        List.of(
                                ModBlocks.TALL_ALLIUM.get(),
                                ModBlocks.BLUE_TALL_ALLIUM.get()
                        ))
        );
        ...
        register(context, ModKeyFeatures.WATER_HYACINTH_PATCH.config(), Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(
                ...
                new SimpleBlockConfiguration(new WeightedStateProvider(builderBedPatch(ModBlocks.WATER_HYACINTH.get(), 4))),
        ...
        register(context, ModKeyFeatures.WATER_POPPY_PATCH.config(), Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(
                Feature.SIMPLE_BLOCK,
                new SimpleBlockConfiguration(new WeightedStateProvider(builderBedPatch(ModBlocks.WATER_POPPY.get(), 4))),
                List.of(Blocks.WATER)
        ));
        ...
        createPatch(context, ModKeyFeatures.WELWITSCHIA_PATCH.config(), 16, 5, 2, List.of(ModBlocks.WELWITSCHIA.get().defaultBlockState()));
        ...
        createBedPatch(context, ModKeyFeatures.SAND_VERBENA_PATCH.config(), 100, 5, 2, ModBlocks.SAND_VERBENA.get(), 4);
        createBedPatch(context, ModKeyFeatures.TORCH_GINGER_PATCH.config(), 78, 5, 2, ModBlocks.TORCH_GINGER.get(), 3);
        ...
        createPatch(context, ModKeyFeatures.GINGER_LILY_PATCH.config(), 64, 6, 2,
                ...
                new TallerFlowerConfig(3,
                        List.of(
                                ModBlocks.ORANGE_GINGER_LILY.get(),
                                ModBlocks.RED_GINGER_LILY.get(),
                                ModBlocks.WHITE_GINGER_LILY.get(),
                                ModBlocks.PINK_GINGER_LILY.get()
                        ))
        );
        ...
        createBedPatch(context, ModKeyFeatures.WOOD_SORREL_PATCH.config(), 78, 5, 2, ModBlocks.WOOD_SORREL.get(), 4);
        ...
        createBedPatch(context, ModKeyFeatures.WINTER_ACONITE_PATCH.config(), 64, 6, 2, ModBlocks.WINTER_ACONITE.get(), 4);

        register(context, ModKeyFeatures.RARE_BEE_BALM.config(), Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.BEE_BALM.get().defaultBlockState())));
    ...
    private static List<BlockState> quickBlockStateList(DeferredObject<Block>... blocks) {
        List<BlockState> states = new ArrayList<>();

        for (DeferredObject<Block> v : blocks) {
            states.add(v.get().defaultBlockState());
        }
    ...
    private static <FC extends FeatureConfiguration, F extends Feature<FC>> void createPatch(BootstapContext<ConfiguredFeature<?,?>> context, ResourceKey<ConfiguredFeature<?, ?>> key, int tries, int xSpread, int ySpread, F feature, FC configuration) {
    ...
    private static void createPatch(BootstapContext<ConfiguredFeature<?,?>> context, ResourceKey<ConfiguredFeature<?, ?>> key, int tries, int xSpread, int ySpread, SimpleWeightedRandomList.Builder<BlockState> builder) {
    ...
    private static void createPatch(BootstapContext<ConfiguredFeature<?,?>> context, ResourceKey<ConfiguredFeature<?, ?>> key, int tries, int xSpread, int ySpread, List<BlockState> list) {
    ...
    private static void createBedPatch(BootstapContext<ConfiguredFeature<?,?>> context, ResourceKey<ConfiguredFeature<?, ?>> key, int tries, int xSpread, int ySpread, Block block, int maxPetal) {
