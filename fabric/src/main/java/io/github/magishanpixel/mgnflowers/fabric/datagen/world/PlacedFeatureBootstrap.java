...
public class PlacedFeatureBootstrap {
    public static void boot(BootstapContext<PlacedFeature> context) {
    ...
    private static void basicPlaced(BootstapContext<PlacedFeature> context, HolderGetter<ConfiguredFeature<?,?>> config, ModKeyFeatures.KeyFeature keyFeature) {
        basicPlaced(context,config,keyFeature, 24);
    }

    private static void basicPlaced(BootstapContext<PlacedFeature> context, HolderGetter<ConfiguredFeature<?,?>> config, ModKeyFeatures.KeyFeature keyFeature, int chance) {
    ...
    private static void register(BootstapContext<PlacedFeature> context, HolderGetter<ConfiguredFeature<?,?>> config, ModKeyFeatures.KeyFeature keyFeature, List<PlacementModifier> modifiers) {
